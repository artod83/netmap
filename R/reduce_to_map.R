...
#'
#' Removes vertices from a \code{network} object which are not present in the
#' link vector produced by \code{\link{link_network_map}} or \code{\link{link_network_map2}}.
#'
...
#'
#' @return A \code{network} object with only the vertices listed in \code{link}.
#'
#' @examples
...
#' # map=st_sf(id=c("a", "b", "c", "e"), st_as_sfc(wkb, EWKB=TRUE))
#' # link=link_network_map(map, net, "id", "name")
